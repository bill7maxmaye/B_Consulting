...
const Slideshow = () => {
  return (
    <div className="relative -z-10 isolate overflow-hidden bg-white">
        ...
        <div className="relative mx-auto">
          <div className="sm:max-w-lg pt-44">
            ...
            <p className="mt-6 text-sm text-gray-700 font-medium lg:text-base text-center sm:text-left max-w-md">
              ...
              investment consulting. Our team of experienced professionals
              provides expert guidance and support to help you navigate complex
              business challenges and achieve your goals. We specialize in
              investment strategy, business consulting, and market research,
              providing customized solutions to meet your unique needs. With our
              client-centric approach, we are committed to delivering
